...
from routes.test_recomendation import recomendation
from routes.test_user import user
from routes.test_vacancy import vacancy
from routes.test_recomendation import recomendation
from test_docs import tags_metadata
from fastapi import FastAPI
